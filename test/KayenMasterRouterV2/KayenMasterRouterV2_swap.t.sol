...
contract KayenMasterRouterRemoveLiquidity_Test is Test {
    ...
    //     assertEq(tokenA_D0.balanceOf(user0), initialTokenBalance - swapAmount, "User should have the correct amount of tokenA_D0 left");
    //     assertGt(user0.balance, initialETHBalance, "User's ETH balance should have increased");
    //     assertEq(user0.balance, initialETHBalance + amounts[1], "User's ETH balance increase should match the swap output");
    // }
    ...
    //     assertEq(tokenA_D6.balanceOf(user0), initialTokenBalance - swapAmount, "User should have the correct amount of tokenA_D6 left");
    //     assertGt(user0.balance, initialETHBalance, "User's ETH balance should have increased");
    //     assertEq(user0.balance, initialETHBalance + amounts[1], "User's ETH balance increase should match the swap output");
    // }
    ...
    //     assertEq(tokenA_D18.balanceOf(user0), initialTokenBalance - swapAmount, "User should have the correct amount of tokenA_D18 left");
    //     assertGt(user0.balance, initialETHBalance, "User's ETH balance should have increased");
    //     assertEq(user0.balance, initialETHBalance + amounts[1], "User's ETH balance increase should match the swap output");
    // }
